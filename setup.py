...
setup(name='django-registration',
      ...
      author='Bruno Cezar Rocha',  # forked from James Bennett <james@b-list.org>
      author_email='rochacbruno@gmail.com',
      url='https://github.com/rochacbruno/django-registration',
      download_url='https://github.com/rochacbruno/django-registration/tarball/master',
